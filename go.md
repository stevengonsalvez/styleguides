...
The purpose of this styleguide is to provide some conventions for working on Go code within M&S. There are already good resources on writing Go code, which are worth reading first:
